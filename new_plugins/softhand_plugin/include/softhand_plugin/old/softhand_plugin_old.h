...
namespace gazebo{
  ...
  protected:
    ...
    enum OperationModes {SoftSynergies = 0 , AdaptiveSynergiesTorque = 1, AdaptiveSynergiesPosition = 2, FingerTorques = 3, FingerPositions = 4};
    OperationModes operationMode;
    std::vector<std::string> mode_names = {"SoftSynergies", "AdaptiveSynergiesTorque", "FingerTorques", "FingerPositions"};
    ...
    double r_finger = 0.0033; // [m] (taken from qbRobotics info!)
    double R_pulley = 0.0053; // [m] (taken from qbRobotics info!)
    double n_param = 4*r_finger/R_pulley;
    double n_syn[4] = {0, n_param, n_param, n_param};

    double thumb_syn[3] = {n_param, n_param, n_param};
    double index_syn[4] = {0.0, n_param, n_param, n_param};
    double middle_syn[4] = {0.0, n_param, n_param, n_param};
    double ring_syn[4] = {0.0, n_param, n_param, n_param};
    double little_syn[4] = {0.0, n_param, n_param, n_param};

    // Elastic value of the spring of each finger (TODO: modify this with different springs values for the fingers)
    double spring_k, spring_k_tendon = 150;
